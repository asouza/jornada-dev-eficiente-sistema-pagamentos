...
@Repository
public interface CombinacaoUsuarioRestauranteRepository extends ContaSelecaoUsuarioRestaurante,org.springframework.data.repository.Repository<CombinacaoUsuarioRestaurante, Long>{
